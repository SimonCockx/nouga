...
\input{components/semantics-types}

\subsection{Semantical Algebra}
\input{components/semantics-algebra}

\subsection{Semantics of Expressions}
\input{components/semantics-expressions}
...
\input{components/typing-declarative}
...
\input{components/typing-algorithmic}
